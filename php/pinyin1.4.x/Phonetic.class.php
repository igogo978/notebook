...
class ExportCSV {
  public function getStuff($msg='null') {
    $arr = func_get_args();
    $row[0] = $arr[0];
    foreach($arr[1] as $id => $name){
      $sn = $id+1;
      $row[$sn][] = $id;
      $row[$sn][] = $name;
...
class Phonetic extends Chinese {
    ...
    //private $_users_name_multiph;
    //private $_users_name_char_pinyin;
...
/*
  public function getUsersNameCharPinyin(){
	return $this->_users_name_char_pinyin;
  }
  public function getUsersNameMultiph(){
	return $this->_users_name_multiph;
  }
*/
